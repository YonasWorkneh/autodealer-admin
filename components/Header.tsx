...
export default function Header() {
  ...
  return (
    <div
      className="flex items-center justify-between gap-4 sm:gap-6 mb-6 px-4 sm:px-6 fixed top-0 left-0 md:left-24 w-full md:w-[calc(100%-96px)] bg-white/70 z-40 py-3 sm:py-4"
