...
import { useLeadsByCarId } from "@/hooks/sales";
...
export default function CarDetailsPage() {
  ...
  const { data: leads, isLoading: isLoadingLeads } = useLeadsByCarId(
    car ? car.id : null,
  );
            ...
            <div className="grid grid-cols-1 xl:grid-cols-2 gap-6 items-start">
              ...
              <Card>
                <CardHeader>
                  <CardTitle className="flex items-center gap-2">
                    <UserCircle className="h-5 w-5" />
                    Lead Interactions ({filteredLeads?.length || 0})
                  </CardTitle>
                </CardHeader>
                <CardContent>
                  {isLoadingLeads ? (
                              ...
                              <TableCell>
                                <div className="flex flex-col">
                                  ...
                                  <span className="text-xs text-muted-foreground">
                                    Car: {lead?.car?.make} {lead?.car?.model}
                                  </span>
                                </div>
                              </TableCell>
                              <TableCell>
                              ...
                              <TableCell>
                                {lead.assigned_sales ? (
                                  <div className="flex flex-col">
                                    ...
                                    <a
                                      href={`mailto:${lead.assigned_sales.email}`}
                                      className="text-xs text-blue-600 hover:text-blue-800 hover:underline transition-colors"
                                    >
                                      {lead.assigned_sales.email}
                                    </a>
                                  </div>
                                ) : (
                        ...
                        <div className="space-y-1">
                          ...
                          <p className="text-sm">
                            ...
                            <span className="font-semibold">
                              ${Intl.NumberFormat("en-US").format(highestBid)}
                            </span>
                          </p>
                          {car.auction_end && (
                            <p className="text-sm text-muted-foreground">
